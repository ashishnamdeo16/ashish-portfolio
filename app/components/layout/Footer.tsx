    ...
    <footer className="py-10 text-center space-y-4 text-[var(--muted)]">
      <div className="flex justify-center gap-6">
        <a
          ...
          className="group rounded-full p-2 text-[var(--muted)] transition-all duration-300 hover:text-[var(--text)] hover:scale-125 hover:-translate-y-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)]"
          aria-label="GitHub"
        >
